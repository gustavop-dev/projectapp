...
pytest backend/candle_app/tests/views/test_orders.py -v
npm test -- frontend/test/stores/orderStore.test.js
npx playwright test frontend/e2e/flows/checkout.spec.js

# ✅ CORRECT — regression tests for related module
pytest backend/candle_app/tests/views/test_orders.py backend/candle_app/tests/serializers/test_order_serializers.py -v
...
| Frontend stores (Pinia / Redux / Zustand) | Unit | Jest / Vitest |
| Frontend composables, hooks, utils | Unit | Jest / Vitest |
| Frontend components | Component | Jest + Vue Test Utils / React Testing Library |
...
□ Tests follow TESTING_QUALITY_STANDARDS.md
