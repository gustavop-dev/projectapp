...
| `admin-accounting-income-crud` | admin | P1 | display,success,error,failure | 25 |
| `admin-accounting-list-error-retry` | admin | P3 | failure,display | 1 |
| `admin-accounting-pocket` | admin | P2 | display,success,error | 4 |
| `admin-accounting-project-bulk-assign` | admin | P1 | success,failure | 3 |
| `admin-accounting-project-coherence` | admin | P1 | success | 1 |
| `admin-accounting-recurring` | admin | P2 | display,success,error,failure | 13 |
...
| `admin-defaults-unified` | admin | P2 | display | 1 |
...
| `admin-document-create` | admin | P2 | display,success,error | 1 |
...
| `admin-document-edit` | admin | P2 | display,success,error | 1 |
...
| `admin-view-map` | admin | P4 | display,success | 1 |
...
| `platform-deliverable-detail` | platform | P2 | — | 0 |
...
- **Coverage:** ✅ Covered (create-through-preview with payload assertions, alcance/estado chips with their counts + focus retention + explicit empty state + "Ver todos" widening + click-outside close, Liquidar routing on mark-paid, generate icon opens locked modal, linked row navigates focused)
