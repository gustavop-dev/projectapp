...
- **Steps:**
  ...
  5. Identifica cada hilo por asunto, cliente, proyecto, canal, estado, cantidad, fecha y borradores; el último mensaje sólo aparece como extracto de una línea.
  ...
  9. Combina varios valores dentro de un filtro y guarda el recorte con nombre como vista propia, distinguida de las opciones de fábrica.
