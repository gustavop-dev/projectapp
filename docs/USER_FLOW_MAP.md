...
- **Steps:**
  ...
  2. Picks the client (the selector warns before selection when it has no email); if needed, saves the canonical email inline without leaving or resetting the draft. Then narrows the income list by Alcance/Estado, picks the income and adjusts concept/value/terms.
