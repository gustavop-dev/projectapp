...
- **Steps:**
  ...
  - [Security] El plaintext no puede recuperarse al recargar; sólo quedan prefijo y hash. Las escrituras se atribuyen a un principal técnico no interactivo del conector, nunca al superusuario humano del Panel.
- **Coverage:** ✅ Covered
