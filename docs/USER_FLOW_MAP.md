...
- **Coverage:** ✅ Covered
- **E2E Spec:** `e2e/admin/admin-document-archive.spec.js` (added 2026-08-11; jerarquía, restauración por cadena, filtro de estado, búsqueda global y contadores añadidos 2026-08-12). La cascada con memoria, la restauración por cadena y las guardas contra huérfanos nuevos se cubren en backend (`content/tests/services/test_document_archive_service.py`, `content/tests/services/test_document_orphan_repair_migration.py`).
