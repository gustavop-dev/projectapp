...
| E2E | Spec con navegación desde el panel, copia de cada documento, errores recuperables, descarga, vista previa y pantalla compacta. Ejecución del navegador pendiente; la primera preparación local no alcanzó readiness estable de Nuxt. |
