...
- Frontend responsive validation uses five named, real-device profiles: 412×915, 835×1194, 1195×835, 1440×900 and 2560×1440.
...
- The portrait-tablet profile is an explicit acceptance target, and admin content is capped at 1440 px on the large-monitor profile.
