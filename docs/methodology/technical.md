...
- Test files: **251 total** (content 181, accounts 66, root/project 4)
...
│   ├── e2e/                     # Playwright E2E tests (207 spec files)
│   ├── test/                    # Jest unit tests (338 test files)
