---
description: Wrapper parametrizado de /plan para ProjectApp — recibe en los argumentos la descripción explícita de la tarea/feature/refactor/bug a planear y produce un plan decision-complete sin volver a preguntar el alcance al usuario.
...
Buscar evidencia: archivos referenciados en los argumentos, patrones existentes (stores Pinia, FBV de DRF, composables), tests relacionados. Usar exploración paralela si el alcance toca >2 áreas.

## PHASE 3 — Mapeo del cambio
Data flow afectado, APIs, estado de Pinia, superficie de tests, migraciones.
