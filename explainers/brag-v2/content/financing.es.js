window.EXPLAINER_CONTENT = {
  "hero": {
    ...
    "subtitle": "Project App. puede financiar el desarrollo e implementación de productos de software en los que identifica valor y potencial sostenible. Entregamos antes de recuperar la totalidad de la inversión y compartimos el riesgo operativo del proyecto.",
    "trust_note": "Una alternativa para convertir una buena oportunidad en un producto real sin trasladar todo el esfuerzo financiero al inicio."
  },
  "eligibility": {
    "title": "Un programa sujeto a evaluación",
    "summary": "Aplican proyectos, fases o conjuntos de fases con un valor total entre $ 20.000.000 COP y $ 140.000.000 COP, ambos inclusive. Cada solicitud pasa por una revisión técnica, comercial y de riesgo que define el aporte inicial —mínimo 20%— y el saldo aprobado.",
  ...
  "options": [
    {
      ...
      "badge": "Recomendada",
      "summary": "La opción de mayor continuidad: financiación, exclusividad, custodia de código, calculadora de requerimientos y un paquete mensual de 60 horas incluido. Al pagar el primer ciclo, puede habilitarse un segundo ciclo de 12 meses sujeto a una nueva evaluación de riesgo.",
      "exclusivity_years": 5,
      "financing_cycles": 2,
      "recommended": true,
    ...
    },
    {
      ...
      "badge": "Alternativa",
      "summary": "Conserva la financiación, la exclusividad, la custodia del código y la transparencia de la calculadora, pero no incluye el paquete mensual de horas.",
      "exclusivity_years": 3,
      "financing_cycles": 1,
      "recommended": false,
  ...
  "conditions": [
    {
      ...
      "summary": "Financiamos el saldo aprobado del desarrollo e implementación de un producto de software o de una o varias de sus fases.",
      "commercial_reason": "El 0% de interés ordinario permite dirigir el capital inicial a validar, operar y hacer crecer el producto mientras el desarrollo se paga en un plazo predecible.",
      "highlights": [
        "Plazo de financiación: 12 meses.",
        "Interés ordinario: 0%.",
        "Se financia hasta el 80% del valor aprobado."
      ]
    },
    {
      "id": "exclusivity",
      ...
      "summary": "Al financiar y participar en la operación, Project App. asume parte del riesgo de éxito del proyecto y se convierte en su casa desarrolladora durante el periodo acordado.",
      "commercial_reason": "La continuidad con un solo equipo protege las decisiones técnicas, reduce la pérdida de contexto y permite responder por la estabilidad del producto que también estamos ayudando a financiar.",
      "highlights": [
    ...
    },
    {
      ...
      "summary": "Una herramienta de transparencia para anticipar el esfuerzo, el trabajo, el tiempo y el rango de precio de cambios futuros.",
      "commercial_reason": "Antes de comprometer presupuesto, el cliente obtiene una lectura comparable del requerimiento y puede decidir con mayor claridad qué priorizar y cuándo ejecutarlo.",
      "highlights": [
    ...
    },
    {
      ...
      "summary": "La alianza a cinco años incluye el Paquete Pro para implementar requerimientos aprobados después de la salida a producción.",
      "commercial_reason": "El producto puede seguir evolucionando sin abrir una negociación desde cero por cada ajuste pequeño, manteniendo capacidad técnica previsible durante la operación.",
      "highlights": [
    ...
    },
    {
      ...
      "summary": "Cada cuota se paga entre los días 1 y 5 calendario del mes. Una cuota en mora aumenta en 2% el costo vigente del Hosting.",
      "commercial_reason": "La regla hace visible desde el inicio el costo de incumplir y compensa gradualmente el riesgo que Project App. asume al entregar y operar antes de recuperar la totalidad de la inversión.",
      "highlights": [
    ...
    },
    {
      ...
      "summary": "El proyecto, una fase o el conjunto de fases a financiar debe tener un valor total entre $ 20.000.000 COP y $ 140.000.000 COP, ambos inclusive.",
      "commercial_reason": "El rango concentra el programa en iniciativas donde la financiación puede crear capacidad real de ejecución y mantiene una exposición responsable para ambas partes.",
      "highlights": [
        "Monto mínimo elegible: $ 20.000.000 COP.",
        "Monto máximo elegible: $ 140.000.000 COP.",
    ...
    },
    {
      ...
      "number": "07",
      "icon": "◒",
      "title": "Análisis de riesgo y aporte desde el 20%",
      "summary": "El primer pago se define mediante el análisis de riesgo y nunca será inferior al 20% del valor total. El saldo financiado puede llegar hasta el 80%.",
      "commercial_reason": "El aporte alinea el compromiso inicial del cliente con el riesgo que Project App. asume al desarrollar y operar antes de recuperar la totalidad de la inversión.",
      "highlights": [
        "El análisis de riesgo define el porcentaje final del primer pago.",
        "Abono mínimo: 20% del valor total.",
        "Financiación máxima: 80% del valor aprobado."
      ]
    }
  ],
  "calculator": {
    ...
    "summary": "No necesitas conocer una metodología técnica. La herramienta toma el requerimiento en lenguaje natural y devuelve una referencia comercial consistente para conversar sobre prioridad, tiempo y presupuesto.",
    "input": {
    ...
    "disclaimer": "El resultado es orientativo y no reemplaza la validación técnica ni la cotización formal que fija alcance, cronograma y precio definitivo."
  },
  "package": {
    "title": "Capacidad mensual para la evolución del producto",
    "summary": "El paquete está pensado principalmente para cambios pequeños y acotados —por ejemplo, requerimientos XS o S—. Un requerimiento de mayor tamaño puede consumir más capacidad, requerir varios ciclos o cotizarse y programarse por separado.",
  ...
  "legal_terms": [
    {
      ...
      "items": [
        ...
        "El alcance debe sumar entre $ 20.000.000 COP y $ 140.000.000 COP, ambos inclusive.",
        "El aporte inicial es como mínimo del 20%; el análisis puede exigir uno mayor.",
    ...
    },
    {
      ...
      "items": [
        "Cada cuota debe pagarse entre los días 1 y 5 calendario del mes correspondiente.",
  ...
  "cta": {
    ...
    "body": "Cuéntanos qué producto quieres construir, qué etapa necesitas financiar y cuál es el resultado que esperas alcanzar.",
    "button": "Hablar por WhatsApp",
    "whatsapp_url": "https://wa.me/573238122373?text=Hola%2C%20quiero%20solicitar%20una%20evaluaci%C3%B3n%20de%20mi%20proyecto%20de%20software%20para%20el%20Programa%20de%20Alianza%20de%20Project%20App."
  },
  "disclaimer": "Información comercial de referencia. La aprobación y las condiciones definitivas dependen de la propuesta y del contrato suscrito por las partes.",
  "language": "es",
  "financing_months": 12,
  "minimum_project_value_cop": 20000000.0,
  "maximum_project_value_cop": 140000000.0,
  ...
  "canonical_path": "/es-co/partnership-program",
