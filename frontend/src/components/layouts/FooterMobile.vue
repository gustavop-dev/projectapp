...
const solutions = computed(() => [
  { name: globalMessages.value?.solutions?.home, href: 'home' },
  { name: globalMessages.value?.solutions?.about, href: 'aboutUs' },
  { name: globalMessages.value?.solutions?.web_designs, href: 'webDesigns' },
  { name: globalMessages.value?.solutions?.web_developments, href: 'portfolioWorks' },
  { name: globalMessages.value?.solutions?.custom_software, href: 'customSoftware' },
  { name: globalMessages.value?.solutions?.animations_3d, href: '3dAnimations' },
  { name: globalMessages.value?.solutions?.prices, href: 'eCommercePrices' },
