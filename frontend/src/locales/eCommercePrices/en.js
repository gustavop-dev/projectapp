export default {
  hero_section: {
    title_line1: "We don't use WordPress",
  ...
  product_details: {
    ...
    responsive_design: {
      ...
      description: "Your website will adapt seamlessly to all screen sizes, from desktops to smartphones. A responsive design enhances user experience, improving accessibility and engagement across devices.",
    },
    animations: {
      title: "Animations",
      description: "We create smooth, interactive animations that enhance user engagement. From subtle transitions to dynamic effects, animations bring your website to life, making it more immersive and modern.",
      click: "Click to see examples.",
    },
    mobile_app: {
      title: "Mobile App (Hybrid)",
      description: "A hybrid mobile app runs on both web and mobile, allowing users to install it on their phone without needing an app store. It combines web accessibility with mobile app-like performance.",
    },
    price_label: "$",
    currency: "USD",
    conversion_rate: 0.0006,
    development_time_label: "",
    server: "Recommended server"
  },
  wordpress_component: {
    our_products_are: "Our products are",
    why_not_wordpress: "Why not WordPress?",
    quality_attributes: [
      {
