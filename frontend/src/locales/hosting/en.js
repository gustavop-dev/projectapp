export default {
    main_title: "Exclusive Hosting, Exclusive Performance",
    main_subtitle: "Not Shared, Just Superior",
    section_title: "Our Hosting Stands Out",
    section_subtitle: "Experience the Difference of Dedicated Hosting",
    description: "At Project App, we understand the importance of reliable and high-performing hosting for web applications developed with custom code. That's why our dedicated hosting solutions are tailored to meet the needs of professional developers and businesses seeking top-notch performance and security.",
