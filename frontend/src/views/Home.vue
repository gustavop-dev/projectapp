<template>
  <div>
    <div>
      ...
      <InitialVideo :play_text="messages.video.text"></InitialVideo>
...
import InitialVideo from '@/components/home/InitialVideo.vue'; // Import the InitialVideo component, likely the main video of the homepage
