<template>
  <nav
    ...
    class="flex flex-col gap-3 py-3 sm:grid sm:grid-cols-[1fr_auto_1fr] sm:items-center"
    :aria-label="ariaLabel"
  >
    <p v-if="totalItems > 0" class="text-xs text-text-muted text-center sm:text-left sm:col-start-1">
