    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-3">
          ...
          <BaseButton variant="danger-ghost" icon-only size="sm" aria-label="Eliminar" :data-testid="`section-delete-${section.section_type}`" title="Eliminar sección" @click.stop="handleDeleteSection(section)">
