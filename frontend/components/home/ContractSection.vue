...
import videoMobileSrc from '~/assets/videos/presentationMobile.mp4'

const { messages } = useMessages()

const cardBgImage = imgCardLanding
const videoMobile = videoMobileSrc
...
const typewriterAnimation = () => {
  ...
  words.forEach((word) => {
    ...
    typewriterTl.to(typewriterText.value, {
