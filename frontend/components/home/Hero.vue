          ...
          <div class="space-y-8 lg:space-y-10">
            ...
            <div class="flex flex-wrap items-center gap-x-5 gap-y-3">
              ...
              <a
                ...
                class="inline-flex items-center gap-2.5 rounded-full bg-lemon px-6 py-3 text-sm font-semibold text-black shadow-md transition-all hover:scale-105 hover:bg-lemon/90 hover:shadow-lg sm:text-base"
              >
              ...
              <button
                type="button"
                class="group inline-flex items-center gap-2 text-sm font-semibold text-esmerald underline-offset-4 transition hover:underline sm:text-base"
          ...
          <div class="relative hidden lg:col-start-2 lg:row-start-1 lg:block">
            <div class="art-blob" tabindex="0" role="button" :aria-label="artPhrase">
              <div class="art-blob__content">
                <svg class="mb-2 h-6 w-6 text-esmerald/70" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p class="font-serif text-lg italic leading-snug text-esmerald">{{ artPhrase }}</p>
              </div>
            </div>
