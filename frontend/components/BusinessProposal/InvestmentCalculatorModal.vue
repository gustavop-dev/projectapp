...
const groupLabels = {
  ...
  qr_generator_module: { es: '🔳 Generador de Códigos QR', en: '🔳 QR Code Generator' },
  content_generator_module: { es: '✍️ Generador de Contenido con IA', en: '✍️ AI Content Generator' },
