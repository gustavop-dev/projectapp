          ...
          <div class="share-modal-card bg-surface dark:bg-primary rounded-t-3xl sm:rounded-2xl shadow-2xl w-full sm:max-w-md sm:mx-4 p-6 sm:p-8 ring-1 ring-transparent dark:ring-esmerald-light/15">
            <div class="flex items-center justify-between mb-6">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <h3 class="text-lg font-bold text-text-brand dark:text-text-brand">{{ t.shareTitle }}</h3>
            ...
            <button
              v-if="canNativeShare"
              class="w-full flex items-center justify-center gap-2.5 px-4 py-3.5 bg-primary dark:bg-accent-soft text-accent dark:text-text-brand rounded-xl font-medium text-sm hover:bg-primary-strong dark:hover:bg-accent-soft/90 transition-colors shadow-sm"
              @click="nativeShare"
            >
            ...
            <p v-else class="text-center text-xs text-text-brand/50 dark:text-text-brand/55 mt-2">
              {{ t.copyHint }}
            </p>
          </div>
        </div>
