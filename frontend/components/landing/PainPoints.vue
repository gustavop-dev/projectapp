<template>
  <section class="mt-12 mb-12 lg:mb-16 px-3 lg:px-32 lg:mt-16">
    <div class="max-w-7xl mx-auto">
      ...
      <!-- Editorial layout: bg image left + stacked cards right -->
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">

        <!-- Left: Background image card with bridge text overlay -->
        <div
          ref="imageRef"
          class="relative rounded-3xl overflow-hidden min-h-[280px] lg:min-h-[600px] bg-cover bg-center opacity-0"
          :style="{ backgroundImage: `url(${bgImage})` }"
        >
          <div class="absolute inset-0 bg-gradient-to-t from-esmerald-dark/80 via-esmerald/60 to-transparent" />
...
import imgBg from '~/assets/images/home/services/bg/card-technologies-1.webp'
