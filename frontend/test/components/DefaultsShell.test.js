...
describe('DefaultsShell — mode computed', () => {
  it('defaults to proposal mode when no query param', async () => {
    ...
    expect(wrapper.find('[data-testid="defaults-mode-proposal"]').classes()).toContain('bg-emerald-600');
  ...
  it('activates diagnostic mode when ?mode=diagnostic', async () => {
    ...
    expect(wrapper.find('[data-testid="defaults-mode-diagnostic"]').classes()).toContain('bg-emerald-600');
