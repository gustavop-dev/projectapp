...
if (batches.length > 1) {
  ...
  if ((args.has('--all') || process.env.RESPONSIVE_ALL === '1') && aggregateRows.length !== 570) {
    throw new Error(`La ejecución completa debe producir 570 celdas; recibidas ${aggregateRows.length}`);
  }
  const report = {
