...
if (batches.length > 1) {
  ...
  if ((args.has('--all') || process.env.RESPONSIVE_ALL === '1') && aggregateRows.length !== 560) {
    throw new Error(`La ejecución completa debe producir 560 celdas; recibidas ${aggregateRows.length}`);
  }
  const report = {
