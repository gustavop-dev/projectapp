...
if (batches.length > 1) {
  ...
  if ((args.has('--all') || process.env.RESPONSIVE_ALL === '1') && aggregateRows.length !== 575) {
    throw new Error(`La ejecución completa debe producir 575 celdas; recibidas ${aggregateRows.length}`);
  }
  const report = {
