...
const showNavbar = computed(() => {
  ...
  return !path.includes('/panel') && !path.includes('/proposal') && !path.includes('/platform') && !path.includes('/diagnostic') && !path.includes('/additional-modules') && !path.includes('/financing') && !path.includes('/lk/')
})
