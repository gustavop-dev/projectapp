    ...
    views: [
      {
        ...
        notes: 'Tema local persistente, controles flotantes como en propuestas y diálogo para copiar o compartir el enlace actual.',
        audience: 'public',
        viewType: 'readonly',
      },
    ],
  ...
  },
  {
    ...
    views: [
      ...
      },
      {
        ...
        reference: 'Programa de Alianza, visibilidad del video, gestión de otrosíes y políticas versionadas de financiación',
        audience: 'admin',
        viewType: 'list',
      },
      {
