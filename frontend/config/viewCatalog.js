...
export const viewCatalogSections = [
  {
    ...
    views: [
      ...
      {
        label: 'Linktree público',
        url: '/lk/:handle',
        group: 'Linktrees',
        file: 'frontend/pages/lk/[handle].vue',
        reference: 'pagina publica del linktree con tema basico o plantilla HTML validada, enlaces con analitica, vCard, compartir e instalacion',
        audience: 'public',
        viewType: 'detail',
      },
      {
    ...
    views: [
      {
        ...
        reference: 'índice público indexable con detalle en modal, tour guiado, video explicativo de 45 segundos y descarga PDF',
        notes: 'Tema local persistente y controles flotantes para tema, guía, PDF y compartir el enlace actual.',
        audience: 'public',
        viewType: 'list',
      },
      {
        ...
        reference: 'selección privada por enlace con seguimiento, tour guiado, video explicativo de 45 segundos y descarga PDF',
        audience: 'public',
        viewType: 'detail',
        notes: 'No se indexa ni expone destinatario, cliente o métricas; conserva selección al compartir y tema local en controles y modales.',
      },
    ],
  },
  {
    id: 'public-financing',
    label: 'Programa de Alianza (público)',
    description: 'Condiciones comerciales del Programa de Alianza para productos de software.',
    views: [
      {
        label: 'Vista pública del Programa de Alianza',
        url: '/partnership-program',
        group: 'Programa de Alianza',
        file: 'frontend/pages/partnership-program/index.vue',
        reference: 'vista pública bilingüe con comparación, acordeones legales, tour guiado, video explicativo de 45 segundos, WhatsApp y descarga PDF',
        notes: 'Compara modalidades de tres y cinco años; sólo la de cinco incluye exclusividad conceptual de Project App. para proyectos competidores del mismo sector y nicho. Tema local, controles flotantes y diálogo para compartir.',
        audience: 'public',
        viewType: 'readonly',
      },
    ],
    ...
    views: [
      {
        ...
        notes: 'Admite ?mode=detailed, ?mode=executive, ?mode=technical y ?mode=legal para abrir modos específicos.',
        audience: 'public',
        viewType: 'detail',
      },
    ],
  ...
  {
    id: 'public-secure-links',
    label: 'Enlaces seguros públicos',
    description: 'Páginas para abrir un enlace de un solo uso o enviarle información sensible al equipo.',
    views: [
      {
        label: 'Crear enlace seguro (clientes)',
        url: '/secure-link',
        group: 'Enlaces seguros',
        file: 'frontend/pages/secure-link/index.vue',
        reference: 'formulario público para enviar información sensible al equipo',
        notes: 'Con captcha y límite por IP; sólo el equipo puede abrir los enlaces creados aquí. Sin analítica.',
        audience: 'public',
        viewType: 'create',
      },
      {
        label: 'Abrir enlace seguro',
        url: '/secure-link/view',
        group: 'Enlaces seguros',
        file: 'frontend/pages/secure-link/view.vue',
        reference: 'revelado de un enlace de un solo uso',
        notes: 'El token viaja en el fragmento (#). Abrir la página no gasta el enlace; se gasta al pulsar Ver contenido.',
        audience: 'public',
        viewType: 'readonly',
      },
    ],
    ...
    views: [
      {
        ...
        reference: 'acceso al panel mediante Django Admin con CAPTCHA obligatorio',
        audience: 'admin',
        viewType: 'auth',
      },
      {
      ...
      {
        label: 'Programa de Alianza',
        url: '/panel/partnership-program',
        group: 'Programa de Alianza',
        file: 'frontend/pages/panel/partnership-program/index.vue',
        reference: 'Programa de Alianza, exclusividad conceptual sólo a cinco años, visibilidad del video, gestión de otrosíes y políticas versionadas de financiación',
        audience: 'admin',
        viewType: 'list',
      },
      {
        label: 'Crear otrosí de financiación',
        url: '/panel/partnership-program/new',
        group: 'Programa de Alianza',
        file: 'frontend/pages/panel/partnership-program/new.vue',
        reference: 'formulario para seleccionar cliente y preparar un borrador contractual',
        audience: 'admin',
        viewType: 'create',
      },
      {
        label: 'Detalle del otrosí de financiación',
        url: '/panel/partnership-program/:id',
        group: 'Programa de Alianza',
        file: 'frontend/pages/panel/partnership-program/[id].vue',
        reference: 'edición, PDF, firma privada, ciclo de vida, segundo ciclo, versión de política aplicada e historial auditable',
        audience: 'admin',
        viewType: 'detail',
      },
      {
        label: 'Programa de Alianza (enlace anterior)',
        url: '/panel/financing',
        group: 'Programa de Alianza',
        file: 'frontend/pages/panel/financing/index.vue',
        reference: 'compatibilidad: redirige a /panel/partnership-program',
        audience: 'admin',
        viewType: 'redirect',
      },
      {
        label: 'Crear otrosí (enlace anterior)',
        url: '/panel/financing/new',
        group: 'Programa de Alianza',
        file: 'frontend/pages/panel/financing/new.vue',
        reference: 'compatibilidad: redirige a /panel/partnership-program/new',
        audience: 'admin',
        viewType: 'redirect',
      },
      {
        label: 'Detalle del otrosí (enlace anterior)',
        url: '/panel/financing/:id',
        group: 'Programa de Alianza',
        file: 'frontend/pages/panel/financing/[id].vue',
        reference: 'compatibilidad: redirige a /panel/partnership-program/:id',
        audience: 'admin',
        viewType: 'redirect',
      },
      {
      ...
      {
        label: 'Linktrees del panel',
        url: '/panel/linktrees',
        group: 'Linktrees',
        file: 'frontend/pages/panel/linktrees/index.vue',
        reference: 'listado de linktrees personalizables con handle publico /lk/@handle',
        audience: 'admin',
        viewType: 'list',
      },
      {
        label: 'Editar linktree',
        url: '/panel/linktrees/:id/edit',
        group: 'Linktrees',
        file: 'frontend/pages/panel/linktrees/[id]/edit.vue',
        reference: 'editor de identidad, colores, logo, Google Fonts y plantillas HTML: carga ZIP o archivos, validacion, capturas, imagenes editables, biblioteca por cliente e historial de publicaciones',
        audience: 'admin',
        viewType: 'edit',
      },
      {
      ...
      },
      {
        ...
        reference: 'vista de creación de documento',
        audience: 'admin',
        viewType: 'create',
      },
      {
      ...
      {
        label: 'Enlaces seguros',
        url: '/panel/secure-links',
        group: 'Comunicaciones',
        file: 'frontend/pages/panel/secure-links/index.vue',
        reference: 'enlaces de un solo uso para compartir información sensible',
        notes: 'Crea, copia, revoca, reactiva o regenera enlaces; muestra el contenido cifrado con auditoría y el historial de aperturas. La pestaña Recibidos reúne lo que envían los clientes desde la página pública; ?link=<id> abre el detalle.',
        audience: 'admin',
        viewType: 'list',
      },
      {
        ...
        reference: 'vista de envío de emails con branding del panel, varios destinatarios y copias',
        audience: 'admin',
        viewType: 'config',
      },
      {
      ...
      },
      {
        ...
        reference: 'catalogo administrable de estados y efectos operativos de proyectos',
        audience: 'admin',
        viewType: 'config',
      },
      {
    ...
    views: [
      {
        ...
        reference: 'vista dashboard del modulo contable: utilidad, estadisticas y cartera pendiente por cobrar',
        audience: 'admin',
        viewType: 'dashboard',
      },
      {
  ...
  },
  {
    ...
    views: [
      ...
      },
      {
        ...
        reference: 'redirect de compatibilidad hacia proyectos',
        audience: 'client',
        viewType: 'redirect',
      },
      {
        label: 'Tablero global (redirect)',
        url: '/platform/board',
        group: 'Compatibilidad',
      ...
      {
        label: 'Cambios globales (redirect)',
      ...
      {
        label: 'Entregables globales (redirect)',
      ...
      {
        label: 'Accesos globales (redirect)',
        url: '/platform/access',
        group: 'Compatibilidad',
        file: 'frontend/pages/platform/access.vue',
        reference: 'redirect de compatibilidad hacia proyectos',
        audience: 'client',
        viewType: 'redirect',
      },
      {
        label: 'Cuentas de cobro globales (redirect)',
      ...
      {
        label: 'Cuenta de cobro global (redirect)',
      ...
      },
      {
        ...
        group: 'Documentos',
        file: 'frontend/pages/platform/documents/index.vue',
        reference: 'portal de documentos, descargas y firma del cliente',
        audience: 'client',
        viewType: 'list',
      },
      {
        ...
        reference: 'login de plataforma con CAPTCHA obligatorio y reintento ante fallas',
        audience: 'client',
        viewType: 'auth',
      },
      {
      ...
      },
      {
        ...
        reference: 'accesos por ambiente: URLs, usuario, contraseña cifrada, repositorio y notas sensibles',
        audience: 'admin',
        viewType: 'edit',
        notes: 'Revelar, copiar, editar y borrar cada secreto; el mismo editor se abre desde /panel/projects.',
      },
      {
...
export const proposalViewReferenceGuide = [
  ...
  },
  {
    ...
    recommendedName: 'vista publica de propuesta en modo detallado, ejecutivo, tecnico o contractual',
    url: '/proposal/:uuid?mode=detailed|executive|technical|legal',
    file: 'frontend/pages/proposal/[uuid]/index.vue',
