  ...
  },
  {
    ...
    views: [
      ...
      },
      {
        ...
        reference: 'Programa de Alianza, visibilidad del video y gestión de otrosíes de financiación',
        audience: 'admin',
        viewType: 'list',
      },
      {
      ...
      },
      {
        ...
        reference: 'edición, PDF, firma privada, ciclo de vida, segundo ciclo e historial auditable',
        audience: 'admin',
        viewType: 'detail',
      },
      {
      ...
      },
      {
        ...
        reference: 'modulo de proyectos: ciclo real, filtros, creacion, edicion e historico',
        audience: 'admin',
        viewType: 'list',
      },
      {
