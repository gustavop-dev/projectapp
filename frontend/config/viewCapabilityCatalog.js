...
const panelCapabilities = [
  ...
  capability(
    ...
    [
      ...
      feature('panel-financing', 'Gestionar financiación y otrosíes',
  ...
  capability(
    ...
    [
      feature('public-financing', 'Comprender el programa de financiación',
        'Presenta dos opciones de alianza, cuatro condiciones, reglas expandibles, tour guiado, video explicativo, PDF y contacto directo.',
