...
const panelCapabilities = [
  ...
  capability(
    ...
    [
      ...
      feature('panel-financing', 'Presentar opciones de financiación',
        'Reúne las condiciones bilingües, la vista pública y el PDF del programa de financiación.',
        'Permite explicar la alianza, comparar plazos y abrir una evaluación con reglas transparentes.',
        ['/panel/financing'],
...
const publicCapabilities = [
  ...
  capability(
    'public-financing-experience', 'Financiación de software',
    ...
    [
      feature('public-financing', 'Comprender el programa de financiación',
        'Presenta dos opciones de alianza, cuatro condiciones, reglas expandibles, PDF y contacto directo.',
