  ...
  capability(
    ...
    [
      feature('public-additional-modules', 'Explorar módulos adicionales',
        'Presenta un índice bilingüe, detalles en modal y una descarga PDF sin precios.',
        ...
        { icon: 'package', actors: ['prospect'], stage: 'Evaluación' }),
    ],
    { icon: 'package', actors: ['visitor', 'prospect'], stage: 'Evaluación' },
  ),
  capability(
