<template>
  <div id="platform-unified-board">
    ...
    <!-- Empty -->
    <div v-else-if="allCards.length === 0" class="rounded-3xl border border-dashed border-border-default py-20 text-center" data-enter>
    ...
    <template v-else>
      ...
      <div class="mb-6 flex flex-wrap gap-3" data-enter>
        ...
        >
          ...
          <span class="text-xs font-medium text-text-default">{{ col.label }}</span>
        ...
        <div v-for="group in groupedByProject" :key="group.projectId">
          ...
          <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            >
              ...
              <h4 class="text-sm font-medium text-text-default">{{ card.title }}</h4>
