    ...
    <section v-else class="space-y-6" data-enter>
      ...
      <div class="grid gap-6 xl:grid-cols-2">
        ...
        <article class="rounded-3xl border border-esmerald/[0.06] bg-white p-6 shadow-sm dark:border-white/[0.06] dark:bg-esmerald dark:shadow-none">
          ...
          <div class="mt-6 grid gap-3 sm:grid-cols-2">
            <NuxtLink :to="localePath('/platform/projects')" class="group rounded-xl border border-esmerald/[0.06] p-4 transition hover:border-esmerald/15 hover:shadow-sm dark:border-white/[0.06] dark:hover:border-white/12">
            ...
            <NuxtLink :to="localePath('/platform/payments')" class="group rounded-xl border border-esmerald/[0.06] p-4 transition hover:border-esmerald/15 hover:shadow-sm dark:border-white/[0.06] dark:hover:border-white/12">
            ...
            <NuxtLink :to="localePath('/platform/changes')" class="group rounded-xl border border-esmerald/[0.06] p-4 transition hover:border-esmerald/15 hover:shadow-sm dark:border-white/[0.06] dark:hover:border-white/12">
            ...
            <NuxtLink :to="localePath('/platform/bugs')" class="group rounded-xl border border-esmerald/[0.06] p-4 transition hover:border-esmerald/15 hover:shadow-sm dark:border-white/[0.06] dark:hover:border-white/12">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between" data-enter>
          ...
          <NuxtLink :to="localePath('/platform/payments')" class="text-xs font-medium text-esmerald transition hover:text-esmerald/70 dark:text-lemon dark:hover:text-lemon/80">
            Ver todo →
          </NuxtLink>
        </div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <div class="flex items-center gap-2">
                  <NuxtLink :to="localePath(`/platform/projects/${sub.project_id}`)" class="text-sm font-semibold text-esmerald transition hover:text-esmerald/70 dark:text-white dark:hover:text-lemon">
                    {{ sub.project_name }}
                  </NuxtLink>
