<template>
  <div id="platform-dashboard" class="space-y-8">
    ...
    <section v-else class="grid gap-6 xl:grid-cols-2" data-enter>
      <article class="rounded-3xl border border-esmerald/[0.06] bg-white p-6 shadow-sm dark:border-white/[0.06] dark:bg-esmerald dark:shadow-none">
      ...
      <article class="rounded-3xl border border-esmerald/[0.06] bg-white p-6 shadow-sm dark:border-white/[0.06] dark:bg-esmerald dark:shadow-none">
        <h2 class="text-base font-medium text-esmerald dark:text-white">Tu espacio está en preparación</h2>
        <p class="mt-2 text-sm leading-6 text-green-light">
          Muy pronto podrás revisar el avance de tus proyectos y pagos desde este portal.
        </p>

        <div class="mt-6 space-y-3">
          <div v-for="module in clientModules" :key="module.title" class="rounded-xl border border-esmerald/[0.06] p-4 dark:border-white/[0.06]">
            <p class="text-sm font-medium text-esmerald dark:text-white">{{ module.title }}</p>
            <p class="mt-1 text-xs text-green-light">{{ module.description }}</p>
          </div>
        </div>
