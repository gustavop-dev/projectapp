  ...
  <div>
    ...
    <div v-else class="max-w-3xl space-y-6">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
        ...
        <textarea v-model="jsonRaw" rows="14" placeholder='{ "title_es": "...", "title_en": "...", "project_url": "...", "content_json_es": { "problem": {...}, "solution": {...}, "results": {...} } }' class="w-full px-4 py-3 border border-gray-200 rounded-xl text-xs font-mono leading-relaxed focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none resize-y" @input="parseJson" />
        ...
        <div v-if="jsonParsed && !jsonError" class="mt-3 bg-emerald-50 border border-emerald-200 rounded-lg px-4 py-3">
          <div class="flex flex-wrap gap-x-6 gap-y-1 text-sm">
            ...
            <span><span class="text-gray-500">URL:</span> <span class="font-medium text-gray-900">{{ jsonParsed.project_url || '—' }}</span></span>
          </div>
        </div>
      </div>
