  ...
  <div>
    ...
    <form v-else-if="work" class="space-y-6 max-w-3xl" @submit.prevent="handleSave">
      ...
      <div class="bg-white dark:bg-esmerald rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-5">
        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-3">Imagen de portada</h3>
        ...
        <div class="flex flex-wrap items-center gap-3">
          <label class="inline-flex items-center gap-2 px-4 py-2 border border-gray-200 dark:border-white/[0.08] rounded-lg text-sm text-gray-700 dark:text-white/70 hover:bg-gray-50 dark:hover:bg-white/[0.04] cursor-pointer transition-colors">
          ...
          <span class="text-xs text-gray-400 dark:text-green-light/60">o usa una URL externa abajo</span>
        </div>
        <input v-model="form.cover_image_url" type="url" class="w-full mt-3 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" placeholder="URL externa de imagen (opcional)" />
      </div>
      ...
      <fieldset class="border border-gray-200 dark:border-white/[0.08] rounded-xl p-5 space-y-4">
        ...
        <div>
          ...
          <input v-model="form.title_es" type="text" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Tagline (ES)</label>
          <input v-model="form.excerpt_es" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
        </div>
        <div>
      ...
      <fieldset class="border border-gray-200 dark:border-white/[0.08] rounded-xl p-5 space-y-4">
        ...
        <div>
          ...
          <input v-model="form.title_en" type="text" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Tagline (EN)</label>
          <input v-model="form.excerpt_en" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
        </div>
        <div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          ...
          <input v-model="form.project_url" type="url" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Slug</label>
          <input v-model="form.slug" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
        </div>
        <div>
      ...
      <fieldset class="border border-gray-200 dark:border-white/[0.08] rounded-xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-green-light/60 mb-1">Meta título (ES)</label>
            <input v-model="form.meta_title_es" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-green-light/60 mb-1">Meta title (EN)</label>
            <input v-model="form.meta_title_en" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-green-light/60 mb-1">Meta descripción (ES)</label>
            <textarea v-model="form.meta_description_es" rows="2" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all resize-y" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-green-light/60 mb-1">Meta description (EN)</label>
            <textarea v-model="form.meta_description_en" rows="2" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all resize-y" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-green-light/60 mb-1">Keywords (ES)</label>
            <input v-model="form.meta_keywords_es" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" placeholder="keyword1, keyword2" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-green-light/60 mb-1">Keywords (EN)</label>
            <input v-model="form.meta_keywords_en" type="text" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] dark:bg-esmerald-dark dark:text-white dark:placeholder:text-green-light/40 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all" placeholder="keyword1, keyword2" />
          </div>
        </div>
      </fieldset>
