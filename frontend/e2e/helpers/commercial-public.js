...
export async function setupCommercialPublic(page, { fail = false, video = false } = {}) {
  ...
  await mockApi(page, ({ apiPath }) => {
    ...
    const catalog = {
      language: 'es', total_modules: 1, show_explainer_video: video,
      categories: [{ slug: 'marketing', name: 'Marketing', modules: [commercialModule] }],
    }
