...
export const ADMIN_ACCOUNTING_RECORD_HISTORY = ['@flow:admin-accounting-record-history', '@module:admin', '@priority:P1'];
...
export const ADMIN_DOCUMENT_CHANGE_HISTORY = ['@flow:admin-document-change-history', '@module:admin', '@priority:P1'];
...
export const ADMIN_DOCUMENT_EMAIL_HISTORY = ['@flow:admin-document-email-history', '@module:admin', '@priority:P1'];
...
export const ADMIN_DOCUMENT_NAVIGATION = ['@flow:admin-document-navigation', '@module:admin', '@priority:P1'];
...
export const ADMIN_FINANCING_AGREEMENT_CREATE = ['@flow:admin-financing-agreement-create', '@module:admin', '@priority:P1'];
...
export const ADMIN_OUTBOUND_EMAIL_HISTORY_ATTACHMENTS = ['@flow:admin-outbound-email-history-attachments', '@module:admin', '@priority:P1'];
...
export const ADMIN_OUTBOUND_EMAIL_HISTORY_RESEND = ['@flow:admin-outbound-email-history-resend', '@module:admin', '@priority:P1'];
...
export const ADMIN_PARTNERSHIP_LEGACY_REDIRECTS = ['@flow:admin-partnership-legacy-redirects', '@module:admin', '@priority:P2'];
...
export const ADMIN_PROPOSAL_FORMALIZATION_DELIVERY = ['@flow:admin-proposal-formalization-delivery', '@module:admin', '@priority:P1'];
...
export const PROPOSAL_CLOSING_CONTACT = ['@flow:proposal-closing-contact', '@module:proposal', '@priority:P2'];
...
export const PROPOSAL_CONTRACT_DRAFT_DOWNLOAD = ['@flow:proposal-contract-draft-download', '@module:proposal', '@priority:P2'];
export const PROPOSAL_CONTRACT_TERMS = ['@flow:proposal-contract-terms', '@module:proposal', '@priority:P1'];
...
export const PROPOSAL_KICKOFF_DISCLOSURE = ['@flow:proposal-kickoff-disclosure', '@module:proposal', '@priority:P2'];
...
export const PUBLIC_FINANCING_THEME = ['@flow:public-financing-theme', '@module:public', '@priority:P2'];
