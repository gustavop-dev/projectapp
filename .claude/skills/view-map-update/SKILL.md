...
argument-hint: "[--check|--apply] [--diff|--since[=<ref>]|--all] [<section-id>|<url-prefix>]"
---
...
Gating ([[_output-protocol]] §4): (1) flags explícitos → directo, sin menú; sin
...
Reportar siguiendo [[_output-protocol]]. En `--check`, entre el veredicto y la
