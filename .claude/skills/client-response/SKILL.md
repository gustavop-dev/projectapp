...
allowed-tools: Bash, Read, Write, AskUserQuestion, mcp__imap-mailbox__imap_list_folders, mcp__imap-mailbox__imap_search, mcp__imap-mailbox__imap_read_message, mcp__claude_ai_Gestor_de_Documentos__list_folders, mcp__claude_ai_Gestor_de_Documentos__list_documents, mcp__claude_ai_Gestor_de_Documentos__read_document, mcp__claude_ai_Gestor_de_Documentos__create_folder, mcp__claude_ai_Gestor_de_Documentos__create_document, mcp__claude_ai_Gestor_de_Documentos__update_document, mcp__claude_ai_Gestor_de_Clientes__search_clients, mcp__claude_ai_Gestor_de_Clientes__list_clients, mcp__claude_ai_Gestor_de_Clientes__get_client, mcp__claude_ai_Gestor_de_Clientes__create_client, mcp__claude_ai_Gestor_de_Comunicaciones__list_threads, mcp__claude_ai_Gestor_de_Comunicaciones__get_thread, mcp__claude_ai_Gestor_de_Comunicaciones__create_thread, mcp__claude_ai_Gestor_de_Comunicaciones__create_message, mcp__claude_ai_Gestor_de_Comunicaciones__mark_message_sent, mcp__claude_ai_Gestor_de_Comunicaciones__list_secure_link_types, mcp__claude_ai_Gestor_de_Comunicaciones__create_secure_link, mcp__claude_ai_Gestor_de_Comunicaciones__get_secure_link
argument-hint: "[--email <UID|búsqueda> | --whatsapp <mensaje pegado> | contexto libre]"
---
...
Excepción **output-es-el-producto** de [[_output-protocol]]: el documento y los dos
