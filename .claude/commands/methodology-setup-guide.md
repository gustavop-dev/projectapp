---
description: "Reference guide for implementing the Memory Bank methodology system with Claude Code skills. Covers directory structure, CLAUDE.md setup, skills configuration, and daily workflows."
---
