...
class TestProjectSubscription:
    ...
    def test_client_cannot_update_subscription(
        self, api_client, client_headers, project, subscription,
    ):
        resp = api_client.patch(
            f'/api/accounts/projects/{project.id}/subscription/',
...
class TestProjectCreationWithProposal:
    def test_create_project_with_proposal_and_hosting(
        ...
        assert sub.start_date.isoformat() == '2026-04-01'
        assert sub.base_monthly_amount == Decimal('250000')
