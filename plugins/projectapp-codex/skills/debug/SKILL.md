---
name: debug
description: "Alias de compatibilidad para el workflow `debug` (Windsurf/Claude legacy). Aplica el mismo procedimiento definido en este skill para mantener comportamiento equivalente en Codex."
