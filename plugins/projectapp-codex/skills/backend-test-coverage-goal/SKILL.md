---
name: backend-test-coverage-goal
description: "Alias de compatibilidad para el workflow `backend-test-coverage-goal` (Windsurf/Claude legacy). Aplica el mismo procedimiento definido en este skill para mantener comportamiento equivalente en Codex."
---
