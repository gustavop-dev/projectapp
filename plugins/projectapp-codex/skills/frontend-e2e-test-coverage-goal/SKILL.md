---
name: frontend-e2e-test-coverage-goal
description: "Alias de compatibilidad para el workflow `frontend-e2e-test-coverage-goal` (Windsurf/Claude legacy). Aplica el mismo procedimiento definido en este skill para mantener comportamiento equivalente en Codex."
---
