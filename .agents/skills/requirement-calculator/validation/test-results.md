...
| Recargo +30% a arquetipos exclusivos de Multi-Tenant (v1.5/v1.8, directriz del dueño) | ✅ (18082026) | `effort-indicators.md` → v1.5: **22 arquetipos** marcados `⇧30%` + modificador nuevo `+30%` en *Costo y riesgo*, con **herencia** a las filas hijas de un `XL` descompuesto. El conjunto salió de una diferencia de conjuntos sobre Vástago: arquetipos del Multi-Tenant **menos** los 33 que la Fase 1.5 ya consumió en estas 53 filas (propuesta comercial #81, 4 etapas, $17.460.954). `market-pricing.md` → v1.8: supuesto declarado + changelog; tarifa, tallas, fórmula, umbrales y proyección **sin cambios**. SKILL: §3.2(c), §3.3 (herencia en la descomposición) y regla estricta nueva. **El baseline no se movió y se verificó, no se prometió:** un script cruza los 22 arquetipos marcados contra las 53 filas cotizadas y da **cero colisiones** — por construcción del conjunto, ninguna fila contratada puede engancharse al recargo. Números y semáforos idénticos a v1.7 (#23 ✅ $5,4M–$7,7M · #24 ✅ $6,4M–$9,0M · #25 ⚠️ $11,7M–$16,6M); los 3 estimates siguen dando `GATE_PASS`. |
