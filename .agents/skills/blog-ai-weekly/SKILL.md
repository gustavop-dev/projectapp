...
Gating ($output-protocol §4): indicación explícita ("redactá y publicá" / "sólo el borrador") → directo, sin menú. Invocación simple (`$blog-ai-weekly`) → UNA AskUserQuestion:
